...
use meadowcap::{McEnumerationCapability, PersonalPrivateInterest, SillyPublicKey, SillySig};
...
fuzz_relative_basic!(
    ...
    Blame;
    |cap :  &McEnumerationCapability< SillyPublicKey, SillySig, SillyPublicKey, SillySig>,  interest:  &PersonalPrivateInterest<16, 16, 16, SillyPublicKey, SillyPublicKey>| {
